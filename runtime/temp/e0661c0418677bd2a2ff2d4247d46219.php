<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\phpStudy\WWW\md\public/../application/index\view\system\sysjct.html";i:1529551108;s:63:"D:\phpStudy\WWW\md\public/../application/index\view\layout.html";i:1529393625;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>
     ...
     <div class="mwnav">
        <ul>
          ...
          <li class="navon"><a href="<?php echo url('System/sysjct'); ?>">寄存室设置</a></li>
    ...
    <div class="mwmain">
      <div class="mwd">
                <div class="mwdba">
                  <form class="add_row one_form  many_form" action="<?php echo url('sysjct_add'); ?>" method="post" >
                    <fieldset>
                ...
                <div class="mwdbb">
                  <div class="mwdbble">
                    <table class="table table-bordered">                      
                      ...
                      <tbody class="wlist">
                        <?php foreach($sys_list_s as $k=>$vo): ?>
                   ...
                   <div class="mwdbbri">
                    <form action="<?php echo url('sysjct_edit'); ?>" method="post" class="edit_row">
                        <fieldset>
